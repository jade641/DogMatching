            ...
            history.map((h, i) => (
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={{ fontSize: 12, color: T.medium }}>{h.d}</Text>
                </View>
                <View
                  style={{
                    paddingHorizontal: 8,
...
export function EventsScreen() {
  ...
  const events = [
    {
      Icon: PawPrint,
      t: "PawMatch Dog Owners Meetup",
      date: "June 28, 2026",
      loc: "Davao City Park",
    },
    {
      Icon: Stethoscope,
      t: "Free Vet Consultation Day",
      date: "July 5, 2026",
      loc: "Mindanao Vet Clinic",
    },
    {
      Icon: Award,
      t: "Dog Training Workshop",
      date: "July 12, 2026",
      loc: "K9 Training Center",
    },
  ];
        ...
        {events.map((ev, i) => (
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                <Text
                  style={{ fontSize: 16, fontWeight: "700", color: T.dark }}
                >
                  {ev.t}
                </Text>
                <View
